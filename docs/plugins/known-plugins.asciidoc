...
* https://github.com/guyplusplus/Kibana-Plugin-Custom-Form-Filter-Visualization[Custom Form Filter] - Base visualization plugin to create via simple coding any custom form based on React EUI. The README has also a step-by-step guide for beginners how to set up a simple development environment to create plugins.
